...
//  删除Ai量体
const delAiMeasure = require('../controller/volume/del-aimeasure')
...
//  新增修改着装人数据
const saveFigures = require('../controller/volume/save-figures')
...
const getAiMeasure  = require('../controller/volume/getAiMeasure')

//设置默认着装人
const setDefaultUser  = require('../controller/volume/setDefaultUser')
...
module.exports = {
    ...
    "DELETE/delAiMeasure": delAiMeasure,
    "DELETE/delCtmMeasure": delCtmMeasure,
    "GET/getCtmmeasure": getCtmmeasure,
    "GET/getAiMeasure": getAiMeasure,
    "POST/saveFigures": saveFigures,
    "PUT/setDefaultUser":setDefaultUser,
