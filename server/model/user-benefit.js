...
class userBenefit {
    ...
    static async getCardListValue(ctx, params) {
        return ctx.$get(ctx.baseUrl + ctx.serverPortUrl.memberService + '/vip-levels/card', params).then((res) => {
            return res
        });
    }
    ...
    static async getCardDetailValue(ctx, params) {
        return ctx.$get(ctx.baseUrl + ctx.serverPortUrl.memberService + '/vip-levels/card-code', params).then((res) => {
            return res
        });
    }
    ...
    static async getVipcardinfoValue(ctx, params) {
        return ctx.$get(ctx.baseUrl + ctx.serverPortUrl.memberService + '/vip-info-aggregates/getMyVipInfo', params).then((res) => {
            return res
        });
    }
    ...
    static async getCardVouchersValue(ctx, params) {
        return ctx.$get(ctx.baseUrl + ctx.serverPortUrl.memberService + '/vip-info-aggregates/card-vouchers', params).then((res) => {
            return res
        });
    }
