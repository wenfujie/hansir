...
class userVolume {
    ...
    static async getVolumnsValue(ctx, params) {
        return ctx.$get(ctx.baseUrl + ctx.serverPortUrl.goodsService + '/measure-hds/info-code-list', params).then((res) => {
            return res
        });
    }
    ...
    static async delAiMeasureValue(ctx, params) {
        return ctx.$delete(ctx.baseUrl + ctx.serverPortUrl.memberService + '/vip-info-dt-figures', params).then((res) => {
            return res
        });
    }
    ...
    static async setDefaultUserValue(ctx, params) {
        let url = '/vip-info-dt-figures/set-default/' + params.id + '?usrId=' +params.usrId + '&companyId=' + params.companyId
    ...
    static async getDoorAddrValue(ctx, params) {
        return ctx.$get(ctx.baseUrl + ctx.serverPortUrl.memberService + '/measure-dest-aggregats/dest-list', params).then((res) => {
            return res
        });
    }
    //  获取到店量体可用地址
    ...
    //  新增修改着装人数据
    static async saveFiguresValue(ctx, params) {
    ...
    static async getCtmmeasure(ctx, params) {
        return ctx.$get(ctx.baseUrl + ctx.serverPortUrl.memberService + '/ctmmeasure-hd-aggregates/msrtype/measure-data', params).then((res) => {
            return res
        }, (err) => {});
    }

    //  获取AI量体数据
    static async getAiMeasure(ctx, params) {
        return ctx.$get(ctx.baseUrl + ctx.serverPortUrl.memberService + '/vip-info-dt-figures/page', params).then((res) => {
            return res
        }, (err) => {});
    }
    ...
    static async getVolumeList(ctx, params) {
        return ctx.$get(ctx.baseUrl + ctx.serverPortUrl.memberService + '/salemeasure-hds/page-measure-info', params).then((res) => {
            return res
        });
    }
