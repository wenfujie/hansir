                ...
                <div class="item">
                    ...
                    <div class="item-info">
                        ...
                        >
                            ...
                            <span v-if="tabType === 2" class="info-title-status">已过期</span>
                        </div>
    ...
    methods: {
        ...
        getWechatConfig(item) {
            ...
            let data = {
                ...
                //                    openId: 'oLgWx0ZrPVaZzoishyTV15Z5TcVs',
                wxuuid: baseConstant.publicAccount || Storage.get('properties').publicAccount
            }
